...
const Cart: FC = () => {
    ...
    const totalCount = cartSlice.items.reduce((sum: number, item: any) => {
        ...
        <div className="container container--cart">
            <div className="cart">
                ...
                <div className="content__items">
                    ...
                    {cartSlice.items.map((item: any) => <CartItem key={item.id} {...item} />)}

                </div>
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span> Всего пицц: <b>{totalCount} шт.</b> </span>
                        <span> Сумма заказа: <b>{cartSlice.totalPrice} ₽</b> </span>
                    </div>
